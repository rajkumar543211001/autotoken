# CODE KE SABSE UPAR INJECT KAREIN (Flask server for Free Tier)
...
# ... aapka baaki saara regular code yahan rahega ...

# CODE KE SABSE NICHE POLING WALE SECTION ME BADLEIN:
if __name__ == "__main__":
    # Web server start karein free tier ke liye
    threading.Thread(target=run_web, daemon=True).start()
    
    # Aapka purana monitor thread
